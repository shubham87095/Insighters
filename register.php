...
<section id="title-header">
  <div class="title">  
     <!-- <img class="logo" src="cap.png">Capiz State University <br>Mambusao Satellite College -->
      ...
      <p class="subtitle"> Insighters</p> 
      <p class="subtitle_txt">Elevate Your Mind, Empower Your Future.</p>
  </div>
</section> 
                 ...
                 <div class="form-group">
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                        ...
                        <a href="login.php" class="back-to-login"><i class="fa fa-arrow-left"></i> Back to Login</a>
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff; text-align: center;>
              <p align="center">&copy; Insighters.com</p>
     </footer>
 </section>
